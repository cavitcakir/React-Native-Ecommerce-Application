...
function _getChildNavigation(navigation, childKey, getCurrentParentNavigation) {
  const children = (0, _getChildrenNavigationCache.default)(navigation);
  ...
  const childRouter = (0, _getChildRouter.default)(navigation.router, childRoute.routeName); // If the route has children, we'll use this to pass in to the action creators
  ...
  const actionCreators = _objectSpread({}, navigation.actions, {}, navigation.router.getActionCreators(childRoute, navigation.state.key), {}, childRouter ? childRouter.getActionCreators(focusedGrandChildRoute, childRoute.key) : {}, {}, (0, _getNavigationActionCreators.default)(childRoute));
  ...
  if (children[childKey] && children[childKey].isFirstRouteInParent() === _isFirstRouteInParent) {
    ...
    const childSubscriber = (0, _getChildEventSubscriber.default)(navigation.addListener, childKey);
