...
var _default = (routeConfigs, stackConfig = {}) => {
  ...
  function getInitialState(action) {
    ...
    const params = (routeConfigs[initialRouteName].params || route.params || action.params || initialRouteParams) && _objectSpread({}, routeConfigs[initialRouteName].params || {}, {}, route.params || {}, {}, action.params || {}, {}, initialRouteParams || {});
    ...
    getStateForAction(action, state) {
      ...
      if (behavesLikePushAction(action) && childRouters[action.routeName] !== undefined // undefined means it's not a childRouter or a screen
          ...
          if (action.type !== StackActions.PUSH && lastRouteIndex !== -1) {
            ...
            if (action.params) {
              ...
              routes[lastRouteIndex] = _objectSpread({}, route, {
                params: _objectSpread({}, route.params, {}, action.params)
              });
          ...
          return _objectSpread({}, _StateUtils.default.push(state, route), {
      ...
      if (behavesLikePushAction(action)) {
        ...
        for (let i = 0; i < childRouterNames.length; i++) {
          ...
          if (childRouter) {
            ...
            if (routeToPush) {
              const route = _objectSpread({}, routeToPush, {
      ...
      if (action.type === StackActions.REPLACE) {
        ...
        if (routeIndex !== -1) {
          ...
          routes[routeIndex] = _objectSpread({
            params: getParamsForRouteAndAction(action.routeName, action)
          }, childState, {
            routeName: action.routeName,
