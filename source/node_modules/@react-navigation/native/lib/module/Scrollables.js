...
const WrappedFlatList = React.forwardRef((props, ref) => React.createElement(FlatList, _extends({
  ref: ref
}, props, {
  renderScrollComponent: props => React.createElement(WrappedScrollView, propsMaybeWithRefreshControl(props))
})));
const WrappedSectionList = React.forwardRef((props, ref) => React.createElement(SectionList, _extends({
  ref: ref
}, props, {
  renderScrollComponent: props => React.createElement(WrappedScrollView, propsMaybeWithRefreshControl(props))
